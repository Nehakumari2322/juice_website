...
<section style="background: #E2BED3;">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-4">
                <h1 style="font-size: 5rem;margin-top:17%">Our <br> Menu<img src="<?php echo URLROOT.'/img/19..png'?>"
                        style="margin-top:50px;margin-left:-50px" alt=""></h1>
            </div>
            <div class="col-sm-4" style="">
                <img src="<?php echo URLROOT.'/img/46..png'?>" style="margin-left:-130px;float:right" alt="">
            </div>
        </div>
    </div>
</section>
